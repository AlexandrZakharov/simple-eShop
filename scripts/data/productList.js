const productList = [
  {
    ...
    description: 'Android, экран 6.3" IPS (1080x2340), Qualcomm Snapdragon 665, ОЗУ 4 ГБ, флэш-память 64 ГБ',
    tags: '#Xiaomi',
    button: 'btn'
  },
  {
    ...
    description: 'Android, экран 6.4" AMOLED (1080x2340), Exynos 9610, ОЗУ 4 ГБ, флэш-память 64 ГБ',
    tags: '#Samsung',
    button: 'btn'
  },
  {
    ...
    description: 'Apple iOS, экран 6.1" IPS (828x1792), Apple A13 Bionic, ОЗУ 4 ГБ, флэш-память 64 ГБ',
    tags: '#Iphone',
    button: 'btn'
  },
  {
    ...
    price: 379,
    name: 'HONOR 20',
    description: 'Android, экран 6.26" IPS (1080x2340), HiSilicon Kirin 980, ОЗУ 6 ГБ, флэш-память 128 ГБ',
    tags: '#Honor',
    button: 'btn'
  },
]